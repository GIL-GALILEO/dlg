...
#curl http://solr:6983/solr/meta-test/update?commit=true -d  '<delete><query>*:*</query></delete>'
...
#curl -X POST 'http://solr:6983/solr/meta-test/update/json?commit=true' --data-binary @data.json -H 'Content-type:application/json'
