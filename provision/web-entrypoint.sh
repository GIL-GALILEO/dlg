#!/bin/bash
groupadd -g 999 gitlab-runner && useradd -u 999 -g 999 gitlab-runner
...
sudo -u gitlab-runner bundle install
sudo -u gitlab-runner bundle exec rake db:setup RAILS_ENV=test
sudo -u gitlab-runner bundle exec rspec --color --format documentation